var rtv = {
    ...
    about: function() {
        var about = '<div title="About MY TV">'+
    ...
    player: {
        ...
        spawn: function(path) {
            ...
            if (playlist.info.hasOwnProperty("name")) {
                document.title = `MY TV | ${playlist.info.name}`
            }
                    ...
                    
 {
    ...
    guide: {
        ...
        channels: {
            open: function() {
                var that = this;
                var test = "<div id='customizeChannels' title='Select MY TV Channels'><form>"+this.generateTable()[0].outerHTML+"</form></div>";
                ...
                var channelDialog = $(test).dialog({
                    ...
                    close: function() {
                        //$("<div title='Select MY TV Channels'><p>Please reload MY TV to reflect any changes.</p></div>").dialog({modal: true, width: "auto"});
                    }
                })
                ...
                function save() {
                    ...
                    if (yours.length > 0) {
                        ...
                        var msg = "<div title='Select MY TV Channels - Saved'><p><strong>Your Channels</strong> has been saved, please reload MY TV to reflect any changes.</p>"+lastGone+"</div>"
                        ...
                        $("<div title='Select MY TV Channels - Error'><p><strong>Your Channels</strong> must have at least one channel.</p></div>").dialog({modal: true, width: "auto"});
                    }
                }
            ...
            custom: {
                open: function(share) {
                    ...
                    var managerDialog = $(manager).dialog({
                        ...
                        modal: true,
                        buttons: {
                            "Help": function() { window.open('', '_blank'); },
                            "upload": {
                                text: "Open",
                ...
                save: function(share) {
                    ...
                    if (t.length > 0) {
                        ...
                        var dlg = $("<div title='Custom Channels - Saved'><p><strong>Custom Channels</strong> has been saved, please reload MY TV to reflect any changes.</p></div>").dialog({
                            modal: true,
                            width: "auto",
                            buttons: {
                                "Reload now": function() { location.reload(); },
        ...
        generateHead: function() {
            ...
            $.each([
                ["Close MY TV Guide", function() { rtv.guide.close(); }],
                ...
                ["About MY TV", function() { rtv.about(); }]
            ], function(i,v) {
